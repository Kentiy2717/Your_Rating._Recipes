## Проект "Твой рейтинг. Рецепты."
### Тренировочный проект (⚠️⚠️⚠️еще в разработке⚠️⚠️⚠️). 

Твой рейтинг - сайт посвященный выдержанным (бочковым) напиткам. Данный модуль посвящен рецептам. Также планируется еще 2 модуля - платформа для онлайн дегустаций и рейтинговая база напитков.
